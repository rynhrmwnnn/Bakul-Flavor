                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            ...
                                            <div class="valid-feedback">Masukkan Nama Menu.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-floating mb-3">
                                            ...
                                            <div class="valid-feedback">Masukkan Keterangan Menu.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-floating mb-3">
                                            ...
                                            <div class="valid-feedback">Pilih Kategori Menu.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-floating mb-3">
                                            ...
                                            <div class="valid-feedback">Masukkan Harga Menu.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-floating mb-3">
                                            ...
                                            <div class="valid-feedback">Masukkan Jumlah Stok Menu.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="proses/input_user.php" method="POST">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            ...
                                            <div class="valid-feedback">Masukkan Nama.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-floating mb-3">
                                            <select disabled name="level" aria-label="Default select example" required
                                            ...
                                            <div class="valid-feedback">Pilih Level.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="form-floating mb-3">
                                            ...
                                            <div class="valid-feedback">Masukkan No Hp.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-floating">
                                    ...
                                    <div class="valid-feedback">Masukkan Alamat.
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary"
                            ...
                            <form class="needs-validation" novalidate action="proses/edit_user.php" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            <input
                                                <?php echo ($row['username'] == $_SESSION['username_bakul']) ? 'disabled' : '' ; ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-floating mb-3">
                                            <select name="level" aria-label="Default select example" required id=""
                                                class="form-select">
                                                <?php
                                                $data = array("Admin/Owner", "Kasir", "Pelayan", "Dapur");
                                                foreach($data as $key => $value){
                            ...
                            <form class="needs-validation" novalidate action="proses/delete_user.php" method="POST">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-danger" name="input_user_validate"
                                        value="12345"
                                        <?php echo ($row['username'] == $_SESSION['username_bakul']) ? 'hidden' : '' ; ?>>Hapus</button>
                                </div>
                            </form>
                        </div>
                    </div>
